        ...
        <div class="custom-accordion" id="accordion_1">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion_1">
                ...
                <div class="d-flex">
                    ...
                    <img src="{{ asset('web/images/img-school-1-min.jpg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion_1">
                ...
                <div class="d-flex">
                    <div class="accordion-img mr-4">
                    <img src="{{ asset('web/images/img-school-2-min.jpg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
                    <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion_1">
                ...
                <div class="d-flex">
                    <div class="accordion-img mr-4">
                    <img src="{{ asset('web/images/img-school-3-min.jpg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div>
