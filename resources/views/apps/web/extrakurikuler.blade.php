...
@section('content')
    @include('components.web.jumbotron', ['title' => 'Ekstrakurikuler'])

    <div class="untree_co-section bg-light">
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="0">
                <h2 class="line-bottom text-center mb-4">Artikel Ekstrakurikuler</h2>
                <p>Lihat kegiatan siswa kami.</p>
                </div>
            </div>
                    ...
                    <div class="col-lg-6"  data-aos="fade-up" data-aos-delay="100">
                        <div class="media-h d-flex h-100">
                            <figure>
                                ...
                                <h2 class="mb-3"><a href="#">{{ $item->title }}</a></h2>
