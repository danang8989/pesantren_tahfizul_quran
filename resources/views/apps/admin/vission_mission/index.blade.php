    ...
    <div class="col-lg-12 d-flex align-items-stretch">
        <div class="card w-100">
            <div class="card-body p-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="{{ route('admin.vission_mission.create') }}">
                ...
                <div class="table-responsive">
                    <table class="table text-nowrap mb-0 align-middle">
                        ...
                        <tbody>      
                            @foreach ($vission_mission as $item)
                                <tr>
                                    ...
                                    <td class="border-bottom-0 d-flex">
                                        <a href="{{ route('admin.vission_mission.edit', $item->id) }}">
                                            <button type="button" class="btn btn-warning btn-sm m-1">Edit</button>
                                        </a>
                                        <form action="{{ route('admin.vission_mission.delete') }}" method="POST">
                                            @csrf @method('DELETE')
