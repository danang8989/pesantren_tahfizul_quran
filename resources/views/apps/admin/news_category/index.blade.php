    ...
    <div class="col-lg-9 d-flex align-items-stretch">
        <div class="card w-100">
            <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Kategori Artikel</h5>
                <div class="row">
                    <div class="col-md-6">
                        <a href="{{ route('admin.news_category.create') }}">
                            ...
                            @foreach ($news_category as $item)
                                <tr>
                                    ...
                                    <td class="border-bottom-0 d-flex">
                                        <a href="{{ route('admin.news_category.edit', $item->id) }}">
                                            <button type="button" class="btn btn-warning btn-sm m-1">Edit</button>
                                        </a>
                                        <form action="{{ route('admin.news_category.delete') }}" method="POST">
                                            @csrf @method('DELETE')
