            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.department.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ $department->name }}" name="name" class="form-control form-control-sm" id="name" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="image" class="form-control form-control-sm" id="image" aria-describedby="emailHelp">
                    </div>
