    ...
    <div class="col-lg-9 d-flex align-items-stretch">
        <div class="card w-100">
            <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Rombongan Test</h5>
                <div class="row">
                    <div class="col-md-6">
                        <a href="{{ route('admin.romtest.create') }}">
                            ...
                            @foreach ($romtest as $item)
                                <tr>
                                    ...
                                    <td class="border-bottom-0 d-flex">
                                        <a href="{{ route('admin.student_romtest', $item->id) }}">
                                            <button type="button" class="btn btn-primary btn-sm m-1">Siswa Rombel</button>
                                        </a>
                                        <a href="{{ route('admin.romtest.edit', $item->id) }}">
                                            <button type="button" class="btn btn-warning btn-sm m-1">Edit</button>
                                        </a>
                                        <form action="{{ route('admin.romtest.delete') }}" method="POST">
                                            @csrf @method('DELETE')
