    ...
    <div class="col-lg-9 d-flex align-items-stretch">
        <div class="card w-100">
            <div class="card-body p-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="{{ route('admin.organization_structure.create') }}">
                            ...
                            @foreach ($organization_structure as $item)
                                <tr>
                                    ...
                                    <td class="border-bottom-0 d-flex">
                                        <a href="{{ route('admin.organization_structure.edit', $item->id) }}">
                                            <button type="button" class="btn btn-warning btn-sm m-1">Edit</button>
                                        </a>
                                        <form action="{{ route('admin.organization_structure.delete') }}" method="POST">
                                            @csrf @method('DELETE')
